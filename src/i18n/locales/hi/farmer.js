const farmer = {
  ...
  create_listing: {
    ...
    tools_info: 'औज़ार की जानकारी',
    cattle_info: 'पशु की जानकारी',
    crop_name: 'फसल का नाम',
    tool_name: 'औज़ार का नाम',
    ...
    quantity_tools: 'मात्रा',
    quantity_cattle: 'पशुओं की संख्या',
    price: 'कीमत (₹/किलो)',
    price_quintal: 'कीमत (₹/क्विंटल)',
    price_tools: 'कीमत (₹)',
    price_cattle: 'कीमत (₹/प्रति पशु)',
    location: 'स्थान',
  ...
  farmer_inquiry: {
    title: 'पूछताछ',
    required: '*',
    inquiry_type_label: 'पूछताछ प्रकार',
    seeds: 'बीज',
    fertilizers: 'उर्वरक',
    pesticides: 'कीटनाशक',
    tools: 'औज़ार',
    ...
    submit_crop: 'सबमिट करें',
    quantity_label: 'मात्रा',
    quantity_placeholder: 'मात्रा दर्ज करें',
    notes_label: 'अतिरिक्त नोट्स',
    notes_placeholder: 'अतिरिक्त विवरण दर्ज करें',
    photo_label: 'फोटो अपलोड करें',
    photo_upload: 'फोटो अपलोड करें',
    photo_optional: 'वैकल्पिक',
    photo_change: 'फोटो बदलें',
    submit: 'पूछताछ सबमिट करें',
    success: 'सफलता',
    success_msg: 'पूछताछ सफलतापूर्वक सबमिट हुई',
    error: 'त्रुटि',
    error_msg: 'पूछताछ सबमिट करने में विफल',
    select_inquiry_type: 'कृपया पूछताछ प्रकार चुनें',
    crop_required: 'कृपया फसल चुनें',
    quantity_required: 'कृपया मात्रा दर्ज करें',
    quantity_invalid: 'कृपया वैध मात्रा दर्ज करें',
    please_enter_crop_name: 'कृपया फसल का नाम दर्ज करें',
    image_pick_error: 'चित्र चुनने में विफल',
