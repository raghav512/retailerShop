export default {
  ...
  lang_en_sub: "अपनी भाषा में खेती करें",
  lang_hi_sub: "हिंदी में खेती करें",
  ...
  role_staff_desc: "फसल खरीद, गुणवत्ता जांच, स्टॉक प्रबंधन",
  role_fpo: "एफपीओ",
  role_fpo_desc: "किसानों और योजनाओं का प्रबंधन",
  role_retailer: "रिटेलर",
  role_retailer_desc: "उत्पाद बेचें, इन्वेंटरी प्रबंधित करें",
  role_footer: "आपकी भूमिका हमें आपका अनुभव बेहतर बनाने में मदद करती है",
