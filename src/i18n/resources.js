export const resources = {
  en: {
    translation: {
      ...
      role_farmer: 'Farmer',
      role_farmer_desc: 'Get crop advisory,\nmarketplace access & rewards',
      role_staff: 'Staff',
      role_staff_desc: 'Track field visits, farmer leads\n& performance',
      role_fpo: 'Retailer',
      role_fpo_desc: 'Manage Supply Chain, Inventory',
      role_footer: 'Your role helps us personalize your experience',
      role_retailer: 'Retailer',
      role_retailer_desc: 'Buy and sell agricultural products',
      ...
      retailer_home: {
        ...
        dashboard_title: 'Retailer Dashboard',
        quick_actions: 'Quick Actions',
        marketplace: 'Marketplace',
        marketplace_sub: 'Browse products and buy',
        my_orders: 'My Orders',
        my_orders_sub: 'Track all your orders',
        inquiry: 'Inquiry',
        inquiry_sub: 'Check farmer inquiries',
        documents: 'Documents',
        documents_sub: 'Access important files',
      },
      ...
      retailer_orders: {
        ...
        download_success: 'Receipt saved to Downloads as {{fileName}}',
      ...
      retailer_inquiry: {
        title: 'Inquiry',
        inquiry_type_label: 'What do you want to enquire about?',
        product_name_label: 'Product / Input Name (if known)',
        product_name_placeholder: 'e.g. Urea, Cotton seeds, Sprayer',
        crop_label: 'For which crop is this input needed?',
        select_crop: 'Select Crop',
        quantity_label: 'Required Quantity',
        quantity_placeholder: 'Enter quantity',
        notes_label: 'Additional Notes (Optional)',
        notes_placeholder: 'Any specific requirements or details',
        photo_label: 'Upload Photo (Optional)',
        photo_upload: 'Tap to upload photo',
        ...
        crop_required: 'Crop name is required',
        quantity_required: 'Quantity is required',
        quantity_invalid: 'Enter valid quantity',
        ...
        photos_permission_msg:
          'Camera/Photos access is required. Enable it in Settings.',
      ...
      register_as_fpo: 'Register as Retailer',

      login_failed: 'Login Failed',
      invalid_credentials: 'Invalid credentials',

      /* Retailer REGISTRATION */
      fpo_registration: 'Retailer Registration',
      ...
      enter_details_below:
        'Enter state, district and crop to see current market rates.',
      ...
      farmer_diary: {
        ...
        no_incomes: 'No incomes recorded yet',
        offline: 'Offline',
        offline_msg: 'No internet connection. Please check and try again.',
        delete_income_title: 'Delete Income',
        delete_income_msg: 'Are you sure you want to delete this income entry?',
        ...
        view_ledger: 'View Ledger Details',
        ...
        no_entries_found: 'No entries found for selected date range',
      },

      // Farmer Inquiry screen
      farmer_inquiry: {
        ...
        notes_label: 'Additional Notes (Optional)',
        notes_placeholder: 'Any specific requirements or details',
        photo_label: 'Upload Image (Optional)',
        photo_upload: 'Upload image',
        photo_optional: 'Attach a photo for this inquiry',
        photo_change: 'Tap to change image',
        submit: 'Submit Inquiry',
        select_inquiry_type: 'Please select inquiry type',
        crop_required: 'Crop name is required',
        quantity_required: 'Quantity is required',
        ...
        image_pick_error: 'Failed to process selected image. Please try again.',
      ...
      add_farm: {
        ...
        insufficient_markers_msg:
          'Please place at least 3 markers to define your farm area',
        fill_name: 'Please enter farm name',
        login_required: 'Please login again.',
      ...
      profile_screens: {
        ...
        farmer_category_failed:
          'Failed to update farmer category. Please try again.',
        crops_grown: 'Crops Grown',
        ...
        upload_business_docs: 'Upload your business documents (Optional)',
        upload_business_license: 'Upload Business License',
        upload_gst_certificate: 'Upload GST Certificate',
        upload_trade_license: 'Upload Trade License',
        upload_soil_card: 'Upload Soil Health Card',
        upload_lab_report: 'Upload Lab Report',
        upload_gov_doc: 'Upload Government Document',
        other_documents: 'Other Documents',
        add_additional_documents: 'Add additional documents',
        ...
        disclaimer_text:
          'This application is privately developed and is not affiliated with, endorsed by, or representing any government entity.',
        view_details: 'View details',
        hide_details: 'Hide details',
      ...
      edit_profile: {
        ...
        validation_error: 'Please fix the errors before updating',
        success: 'Success',
        error: 'Error',
      },
      ...
      soil_health_desc:
        'Upload your soil health card for better recommendations',
      ...
      crop_doctor_screen: {
        ...
        max_reports_msg:
          'Maximum {{max}} reports can be stored. Please delete old reports to save new ones.',
      ...
      // Visits Screen (Farmer Management)
      farmer_management: 'Farmer Management',
      farmer_management_sub: 'farmers',
      all_farmers_order_details: 'All Farmers Order Details',
      search_farmers: 'Search farmers...',
      orders: 'orders',
      farmer_orders: 'Farmer Orders',
      no_orders_found: 'No orders found for this farmer',
      status: {
        verified: 'Verified',
        pending: 'Pending',
      },
      ...
      crop_calendar: {
        ...
        header_title: 'Crop Calendar',
        error_fetch: 'Failed to fetch crop details',
        status_done: 'Done',
        status_active: 'Active',
        status_upcoming: 'Upcoming',
        status_live: 'Live',
        overall_progress: '🌱 Overall Growth Progress',
        growth_stages: 'Growth Stages',
        add_sowing_hint: '(Add sowing date to track progress)',
        sown: 'Sown:',
        day: 'Day',
        currently: 'Currently:',
        na: 'N/A',
        none: 'None',
        stages_done: 'stages done',
        of: 'of',
        // Field names
        variety: 'Variety',
        crop_type: 'Crop Type',
        total_duration_days: 'Total Duration Days',
        harvest_indicators: 'Harvest Indicators',
        expected_yield_per_hectare: 'Expected Yield Per Hectare',
        storage: 'Storage',
        method: 'Method',
      ...
      purchase: {
        ...
        receipt_saved: 'Receipt saved to Downloads',
      ...
      chatbot: {
        title: 'Retail Management System AI',
        today: 'Today',
        yesterday: 'Yesterday',
        bot_error_understand:
        ...
        limit_reached_msg:
          "You've reached your daily limit of {{limit}} questions. Your limit will reset tomorrow! 🌅",
      ...
      cart: {
        ...
        update_personal_details:
          'Please update your personal details in the Profile section before placing an order.',
      ...
      fpo_dashboard: 'Retailer Dashboard',
      ...
      document_management_desc:
        'Upload or replace your licenses and certificates. View uploaded documents anytime.',
      ...
      fpo_documents: 'Retailer Documents',
      ...
      files_selected_success: '{{count}} files selected successfully',
      files_selection_trimmed:
        'Only the first {{count}} files were added to stay within the limit.',
      error: 'Error',
      select_doc_first: 'Please select a document first',
      success: 'Success',
      uploaded_successfully: '{{label}} uploaded successfully!',
      files_uploaded_successfully: '{{count}} files uploaded successfully!',
      ...
      document_limit_reached: 'You can keep up to {{count}} files here.',
      upload_new: 'Add New File',
      replacing_file: 'Replacing File {{index}}: ',
      ready_to_upload: 'Ready to upload: {{id}}',
      document_ready: 'new file',
      ...
      private_files: {
        ...
        gst_certificates: 'GST Certificates',
        trade_licenses: 'Trade Licenses',
        no_files_found: 'No files found',
        ...
        download: 'Download',
        cannot_open_file: 'Cannot Open File',
        device_cant_open_try_download:
          "Your device couldn't open this file. Try downloading it instead.",
        download_error: 'Download Error',
        url_not_available: 'File URL not available.',
        download_url_not_available: 'Download URL not available.',
        error: 'Error',
      ...
      profile: {
        ...
        app_name: 'KrishiGyan Retailer App',
      },
      roles: {
      ...
      inquiry_screen: {
        ...
        search_placeholder: 'Search by product, crop or farmer id...',
        loading: 'Loading inquiries...',
        loading_detail: 'Loading inquiry details...',
        empty_title: 'No inquiries found',
        empty_subtitle:
          'Farmer inquiries will appear here once they are raised.',
        empty_search_subtitle:
          'No matching inquiries found. Try a different keyword.',
        error_title: 'Something went wrong',
        error_load_list: 'Failed to load inquiries. Please try again.',
        error_load_detail: 'Failed to load inquiry details. Please try again.',
        error_missing_id: 'Inquiry id is missing.',
        error_invalid_payload: 'Invalid inquiry data received from server.',
        error_not_found: 'Inquiry not found',
        retry: 'Retry',
        back: 'Go Back',
        ...
        description_template:
          'Farmer requested {{inquiryType}} support for {{cropName}} crop. Product requested: {{productName}}. Required quantity: {{quantityLabel}}.',
        attachment_title: 'Attachment',
        attachment_empty: 'No attachment available',
        fallback_na: 'N/A',
        fallback_not_specified: 'Not specified',
        fallback_unknown: 'Unknown',
        fallback_date: 'Date unavailable',
        status: {
          pending: 'New',
          approved: 'Approved',
          rejected: 'Rejected',
      ...
      fpo_home: {
        ...
        farmer_attendance: 'Farmer Attendance',
        farmer: 'Farmer',
        no_farmers_found: 'No farmers found',
      },

      all_active_farms: 'All Active Farms',
      farms_total: 'Farms Total',
      no_active_farms_found: 'No active farms found.',
      ...
      profile: {
        ...
        roles: {
          ...
          Distributor: 'Retailer Administrator',
          user: 'User',
        },
      },
      common: {
      ...
      all_tasks_assigned: {
        ...
        no_tasks_subtitle: 'No tasks have been assigned yet.',
      ...
      assign_task: {
        ...
        description: 'Description',
        description_placeholder: 'Enter task description (optional)',
        assign_to: 'Assign To',
        failed_to_load: 'Failed to load team members',
        retry: 'Retry',
        ...
        location_placeholder: 'Enter task location',
        creating: 'Creating...',
        ...
        validation: {
          ...
          title_max_length: 'Task title cannot exceed 100 characters',
          title_invalid: 'Task title contains invalid characters',
          description_max_length: 'Description cannot exceed 500 characters',
          member_required: 'Please select a team member',
          member_invalid: 'Invalid team member selected',
        ...
        task_failed: 'Failed to create task',
        priority_low: 'Low',
        priority_medium: 'Medium',
        priority_high: 'High',
        category_field_visit: 'Field Visit',
      ...
      task_assigned: {
        title: 'Task Assigned',
        my_tasks: 'My Tasks',
        no_internet: 'No internet connection. Please check and retry.',
        ...
        no_tasks_subtitle: 'Check back later for new assignments',
        task_count_one: '{{count}} task',
        task_count_other: '{{count}} tasks',
      },
      ...
      crop_analytics: {
        ...
        farm_boundary_mapped: 'Farm Boundary Mapped',
        points: 'Points',
        variety: 'Variety',
        sowing: 'Sowing',
        no_crops: 'No Crops',
        crop: 'Crop',
        crops_plural: 'Crops',
        no_crops_planted: 'No crops planted yet',
        no_farm_data: 'No Farm Data Available',
        start_adding_farm: 'Start by adding your first farm',
      },
    },
  },
  ...
  hi: {
    translation: {
      ...
      role_fpo: 'रिटेलर',
      role_fpo_desc: 'आपूर्ति श्रृंखला, इन्वेंटरी प्रबंधित करें',
      role_retailer: 'रिटेलर',
      role_retailer_desc: 'कृषि उत्पाद खरीदें और बेचें',
      ...
      retailer_home: {
        ...
        dashboard_title: 'रिटेलर डैशबोर्ड',
        quick_actions: 'त्वरित कार्य',
        marketplace: 'मार्केटप्लेस',
        marketplace_sub: 'उत्पाद ब्राउज़ करें और खरीदें',
        my_orders: 'मेरे ऑर्डर',
        my_orders_sub: 'अपने सभी ऑर्डर ट्रैक करें',
        inquiry: 'पूछताछ',
        inquiry_sub: 'किसान पूछताछ देखें',
        documents: 'दस्तावेज़',
        documents_sub: 'महत्वपूर्ण फ़ाइलें एक्सेस करें',
      },

      // Retailer Orders
      retailer_orders: {
        title: 'ऑर्डर',
        search_placeholder: 'ऑर्डर ID से खोजें',
        ...
        no_receipt_msg:
          'इस ऑर्डर के लिए रसीद नहीं मिली। सुनिश्चित करें कि ऑर्डर बेचा गया था।',
        downloaded: 'डाउनलोड हो गया!',
        download_success: 'रसीद डाउनलोड में {{fileName}} के रूप में सहेजी गई',
      ...
      retailer_inquiry: {
        title: 'पूछताछ',
        inquiry_type_label: 'आप किस बारे में पूछताछ करना चाहते हैं?',
        product_name_label: 'उत्पाद / इनपुट का नाम (यदि पता हो)',
        product_name_placeholder: 'उदा. यूरिया, कपास के बीज, स्प्रेयर',
        crop_label: 'यह इनपुट किस फसल के लिए चाहिए?',
        select_crop: 'फसल चुनें',
        quantity_label: 'आवश्यक मात्रा',
        quantity_placeholder: 'मात्रा दर्ज करें',
        notes_label: 'अतिरिक्त नोट्स (वैकल्पिक)',
        notes_placeholder: 'कोई विशिष्ट आवश्यकताएं या विवरण',
        photo_label: 'फोटो अपलोड करें (वैकल्पिक)',
        photo_upload: 'फोटो अपलोड करने के लिए टैप करें',
        ...
        crop_required: 'फसल का नाम आवश्यक है',
        quantity_required: 'मात्रा आवश्यक है',
        quantity_invalid: 'मान्य मात्रा दर्ज करें',
        select_unit: 'इकाई चुनें',
        camera: 'कैमरा',
        gallery: 'गैलरी',
        cancel: 'रद्द करें',
        upload_photo_title: 'फोटो अपलोड करें',
        choose_option: 'एक विकल्प चुनें',
        permission_denied: 'अनुमति अस्वीकृत',
        camera_permission_msg:
          'कैमरा एक्सेस आवश्यक है। इसे सेटिंग्स में सक्षम करें।',
        photos_permission_msg:
          'कैमरा/फोटो एक्सेस आवश्यक है। इसे सेटिंग्स में सक्षम करें।',
      ...
      /* Retailer LOGIN */
      fpo_login: 'रिटेलर लॉगिन',
      farmer_listing_details: {
        title: 'किसान सूची विवरण',
        listing_approved: 'सूची सफलतापूर्वक स्वीकृत हो गई',
        listing_rejected: 'सूची सफलतापूर्वक अस्वीकृत हो गई',
      ...
      farm_details: {
        ...
        markers: 'मार्कर',
        points: 'बिंदु',
        no_map_data: 'मैप डेटा उपलब्ध नहीं है',
        active: 'सक्रिय',
      ...
      add_product: {
        ...
        target_crops_placeholder:
          'उदा. गेहूं, चावल, मक्का (अल्पविराम से अलग करें)',
      ...
      document_management_desc:
        'अपने लाइसेंस और प्रमाणपत्र अपलोड या बदलें। अपलोड किए गए दस्तावेज़ों को कभी भी देखें।',
      ...
      fpo_documents: 'रिटेलर दस्तावेज़',
      ...
      files_selected_success: '{{count}} फ़ाइलें सफलतापूर्वक चुनी गईं',
      files_selection_trimmed:
        'सीमा के भीतर रखने के लिए केवल पहली {{count}} फ़ाइलें जोड़ी गईं।',
      error: 'त्रुटि',
      ...
      files_uploaded_successfully:
        '{{count}} फ़ाइलें सफलतापूर्वक अपलोड की गईं!',
      ...
      document_limit_reached: 'यहां अधिकतम {{count}} फ़ाइलें रखी जा सकती हैं।',
      upload_new: 'नई फ़ाइल जोड़ें',
      replacing_file: 'फ़ाइल {{index}} को बदला जा रहा है: ',
      ready_to_upload: 'अपलोड के लिए तैयार: {{id}}',
      document_ready: 'नई फ़ाइल',
      ...
      private_files: {
        ...
        business_licenses: 'व्यवसाय लाइसेंस',
        gst_certificates: 'जीएसटी प्रमाणपत्र',
        trade_licenses: 'व्यापार लाइसेंस',
        no_files_found: 'कोई फ़ाइल नहीं मिली',
        ...
        cannot_open_file: 'फ़ाइल नहीं खोल सकते',
        device_cant_open_try_download:
          'आपका उपकरण इस फ़ाइल को नहीं खोल सका। इसके बजाय इसे डाउनलोड करने का प्रयास करें।',
        download_error: 'डाउनलोड त्रुटि',
        url_not_available: 'फ़ाइल URL उपलब्ध नहीं है।',
        download_url_not_available: 'डाउनलोड URL उपलब्ध नहीं है।',
        error: 'त्रुटि',
        failed_load: 'फ़ाइलें लोड करने में विफल',
        date_not_available: 'तारीख उपलब्ध नहीं',
      },
      area: 'क्षेत्रफल',
      markers: 'मार्कर',
      ...
      register_as_fpo: 'रिटेलर के रूप में पंजीकरण करें',

      login_failed: 'लॉगिन विफल',
      invalid_credentials: 'गलत विवरण',

      /* Retailer REGISTRATION */
      fpo_registration: 'रिटेलर पंजीकरण',
      ...
      enter_details_below:
        'बाजार की वर्तमान दरें देखने के लिए अपना राज्य, जिला और फसल दर्ज करें।',
      ...
      farmer_diary: {
        ...
        total_profit: 'शुद्ध लाभ',
        add_income: '+ आय जोड़ें',
        add_expense: '+ खर्च जोड़ें',
        recent_expenses: 'हालिया खर्च',
        recent_incomes: 'हालिया आय',
        no_expenses: 'अभी तक कोई खर्च दर्ज नहीं',
        no_incomes: 'अभी तक कोई आय दर्ज नहीं',
        offline: 'ऑफलाइन',
        offline_msg:
          'इंटरनेट कनेक्शन नहीं है। कृपया जांचें और पुनः प्रयास करें।',
        delete_income_title: 'आय हटाएं',
        delete_income_msg: 'क्या आप वाकई इस आय प्रविष्टि को हटाना चाहते हैं?',
        delete_expense_title: 'खर्च हटाएं',
        delete_expense_msg:
          'क्या आप वाकई इस खर्च प्रविष्टि को हटाना चाहते हैं?',
        cancel: 'रद्द करें',
        delete: 'हटाएं',
        success: 'सफलता',
        error: 'त्रुटि',
        income_deleted: 'आय सफलतापूर्वक हटाई गई',
        expense_deleted: 'खर्च सफलतापूर्वक हटाया गया',
        delete_failed: 'हटाने में विफल। कृपया पुनः प्रयास करें।',
        view_ledger: 'खाता बही विवरण देखें',
        date_range: 'तिथि सीमा',
        view_details: 'विवरण देखें',
        downloading: 'डाउनलोड हो रहा है...',
        download_pdf: 'PDF डाउनलोड करें',
        ledger_details: 'खाता बही विवरण',
        retry: 'पुनः प्रयास करें',
        income_entries: 'आय प्रविष्टियाँ',
        expense_entries: 'खर्च प्रविष्टियाँ',
        no_entries_found: 'चुनी गई तिथि सीमा में कोई प्रविष्टि नहीं',
      },
      ...
      farmer_inquiry: {
        ...
        other: 'अन्य',
        product_name_label: 'उत्पाद / इनपुट का नाम (यदि पता हो)',
        product_name_placeholder: 'जैसे. यूरिया, कपास के बीज, स्प्रेयर',
        crop_label: 'यह इनपुट किस फसल के लिए चाहिए?',
        select_crop: 'फसल चुनें',
        quantity_label: 'आवश्यक मात्रा',
        quantity_placeholder: 'मात्रा दर्ज करें',
        notes_label: 'अतिरिक्त नोट्स (वैकल्पिक)',
        notes_placeholder: 'कोई विशेष आवश्यकता या विवरण',
        photo_label: 'इमेज अपलोड करें (वैकल्पिक)',
        photo_upload: 'इमेज अपलोड करें',
        photo_optional: 'इस पूछताछ के लिए फोटो संलग्न करें',
        photo_change: 'इमेज बदलने के लिए टैप करें',
        submit: 'पूछताछ सबमिट करें',
        select_inquiry_type: 'कृपया पूछताछ प्रकार चुनें',
        crop_required: 'फसल का नाम आवश्यक है',
        quantity_required: 'मात्रा आवश्यक है',
        quantity_invalid: 'सही मात्रा दर्ज करें',
        select_unit: 'इकाई चुनें',
        success: 'सफलता',
        success_msg: 'पूछताछ सफलतापूर्वक सबमिट की गई',
        error: 'त्रुटि',
        error_msg: 'पूछताछ सबमिट करने में विफल। कृपया पुनः प्रयास करें।',
        image_pick_error:
          'चुनी गई इमेज प्रोसेस नहीं हो सकी। कृपया फिर से प्रयास करें।',
        search_crop: 'फसल खोजें...',
        no_crop_found: 'कोई फसल नहीं मिली',
        enter_crop_name: 'फसल का नाम दर्ज करें',
        crop_name_placeholder: 'उदा., टमाटर',
        submit_crop: 'जमा करें',
      ...
      why_upload_desc:
        'दस्तावेज़ आपके प्रोफाइल को सत्यापित करने में मदद करते हैं।',
      ...
      add_farm: {
        ...
        insufficient_markers_msg:
          'अपने खेत के क्षेत्र को परिभाषित करने के लिए कृपया कम से कम 3 मार्कर लगाएं',
        fill_name: 'कृपया खेत का नाम दर्ज करें',
        login_required: 'कृपया पुनः लॉगिन करें।',
      ...
      profile_screens: {
        ...
        address_update_failed:
          'पता अपडेट करने में विफल। कृपया पुनः प्रयास करें।',
        farmer_category_updated: 'किसान श्रेणी सफलतापूर्वक अपडेट की गई!',
        farmer_category_failed:
          'किसान श्रेणी अपडेट करने में विफल। कृपया पुनः प्रयास करें।',
        ...
        upload_business_docs: 'अपने व्यवसाय दस्तावेज़ अपलोड करें (वैकल्पिक)',
        upload_business_license: 'व्यवसाय लाइसेंस अपलोड करें',
        upload_gst_certificate: 'जीएसटी प्रमाणपत्र अपलोड करें',
        upload_trade_license: 'व्यापार लाइसेंस अपलोड करें',
        upload_soil_card: 'मिट्टी स्वास्थ्य कार्ड अपलोड करें',
        upload_lab_report: 'लैब रिपोर्ट अपलोड करें',
        upload_gov_doc: 'सरकारी दस्तावेज़ अपलोड करें',
        other_documents: 'अन्य दस्तावेज़',
        add_additional_documents: 'अतिरिक्त दस्तावेज़ जोड़ें',
        document_name: 'दस्तावेज़ का नाम',
        add_document: 'दस्तावेज़ जोड़ें',
        add_other_document: 'अन्य दस्तावेज़ जोड़ें',
        ...
        disclaimer_text:
          'यह एप्लिकेशन निजी तौर पर विकसित किया गया है और यह किसी भी सरकारी संस्था से संबद्ध, समर्थित या उसका प्रतिनिधित्व नहीं करता है।',
        view_details: 'विवरण देखें',
        hide_details: 'विवरण छिपाएं',
        disclaimer_content_1:
          'यह एप्लिकेशन निजी तौर पर विकसित किया गया है और किसी भी सरकारी संगठन या प्राधिकरण का प्रतिनिधित्व नहीं करता है।',
        disclaimer_content_2:
          'इस एप्लिकेशन में प्रदर्शित सरकारी योजनाओं या कार्यक्रमों से संबंधित जानकारी पूरी तरह से सूचनात्मक उद्देश्यों के लिए प्रदान की गई है और सार्वजनिक रूप से उपलब्ध स्रोतों पर आधारित है।',
        disclaimer_content_3:
          'उपयोगकर्ताओं को सलाह दी जाती है कि वे दस्तावेज़ जमा करने या कोई कार्रवाई करने से पहले सीधे आधिकारिक सरकारी वेबसाइटों या अधिकृत चैनलों के माध्यम से सभी विवरणों को सत्यापित करें।',
      },
      ...
      crop_doctor_screen: {
        ...
        camera_permission_denied:
          'फ़ोटो लेने के लिए कैमरा और स्टोरेज की अनुमति आवश्यक है।',
        storage_permission_denied:
          'फ़ोटो एक्सेस करने के लिए स्टोरेज की अनुमति आवश्यक है।',
        ...
        api_key_missing:
          'Gemini API कुंजी गायब है। कृपया अपनी कॉन्फ़िगरेशन फ़ाइल जांचें।',
        no_diagnosis_generated: 'कोई निदान उत्पन्न नहीं हुआ।',
        daily_limit_title: 'दैनिक सीमा पूरी हो गई',
        daily_limit_msg:
          'आप अपनी दैनिक विश्लेषण सीमा पर पहुंच गए हैं। कृपया कल पुनः प्रयास करें।',
        api_key_error_title: 'API कुंजी त्रुटि',
        api_key_invalid:
          'Gemini API कुंजी अमान्य है। कृपया एक नई कुंजी बनाएं और अपनी कॉन्फ़िगरेशन अपडेट करें।',
        ...
        max_reports_msg:
          'अधिकतम {{max}} रिपोर्ट सहेजी जा सकती हैं। कृपया नई रिपोर्ट सहेजने के लिए पुरानी रिपोर्ट हटाएं।',
      ...
      crop_calendar: {
        loading: 'फसल विवरण लोड हो रहा है...',
        header_title: 'फसल कैलेंडर',
        error_fetch: 'फसल विवरण प्राप्त करने में विफल',
        status_done: 'पूर्ण',
        status_active: 'सक्रिय',
        status_upcoming: 'आगामी',
        status_live: 'लाइव',
        overall_progress: '🌱 समग्र विकास प्रगति',
        growth_stages: 'विकास चरण',
        add_sowing_hint: '(प्रगति ट्रैक करने के लिए बुवाई की तारीख जोड़ें)',
        sown: 'बोया गया:',
        day: 'दिन',
        currently: 'वर्तमान में:',
        na: 'उपलब्ध नहीं',
        none: 'कोई नहीं',
        stages_done: 'चरण पूर्ण',
        of: 'का',
        // Field names
        variety: 'किस्म',
        crop_type: 'फसल प्रकार',
        total_duration_days: 'कुल अवधि दिन',
        harvest_indicators: 'कटाई संकेतक',
        expected_yield_per_hectare: 'प्रति हेक्टेयर अपेक्षित उपज',
        storage: 'भंडारण',
        method: 'विधि',
        temperature_celsius: 'तापमान सेल्सियस',
        humidity_percent: 'आर्द्रता प्रतिशत',
        ...
        disease_control: 'रोग नियंत्रण',
        harvesting_method: 'कटाई की विधि',
        yield: 'उपज',
        post_harvest: 'कटाई के बाद',
        market_price: 'बाजार मूल्य',
        additional_tips: 'अतिरिक्त सुझाव',
        notes: 'टिप्पणियां',
        // Crop types
        fruit: 'फल',
        vegetable: 'सब्जी',
      ...
      chatbot: {
        ...
        yesterday: 'कल',
        bot_error_understand:
          'क्षमा करें, मैं वह समझ नहीं पाया। कृपया पुनः प्रयास करें।',
        bot_error_connect:
          'मुझे कनेक्ट करने में समस्या हो रही है। कृपया अपना इंटरनेट जांचें और पुनः प्रयास करें।',
        bot_error_timeout:
          'अनुरोध का समय समाप्त हो गया। कृपया पुनः प्रयास करें।',
        limit_reached_msg:
          'आप अपनी दैनिक सीमा {{limit}} प्रश्नों तक पहुँच गए हैं। आपकी सीमा कल रीसेट हो जाएगी! 🌅',
      ...
      cart: {
        ...
        already_removed:
          'यह आइटम पहले ही हटा दिया गया था। रीफ्रेश हो रहा है...',
        ...
        update_personal_details:
          'कृपया ऑर्डर देने से पहले प्रोफ़ाइल अनुभाग में अपने व्यक्तिगत विवरण अपडेट करें।',
      ...
      all_farmers_order_details: 'सभी किसानों के ऑर्डर विवरण',
      search_farmers: 'किसान खोजें...',
      farmer_orders: 'किसान के ऑर्डर',
      no_orders_found: 'इस किसान के लिए कोई ऑर्डर नहीं मिला',
      ...
      home: {
        ...
        attendance: 'उपस्थिति',
        orders: 'ऑर्डर्स',
        task_assigned: 'सौंपे गए कार्य',
        task_detail: 'सौंपा गया कार्य',
      ...
      inquiry_screen: {
        title: 'किसान पूछताछ',
        add_inquiry: 'पूछताछ जोड़ें',
        search_placeholder: 'उत्पाद, फसल या किसान आईडी से खोजें...',
        loading: 'पूछताछ लोड हो रही है...',
        loading_detail: 'पूछताछ विवरण लोड हो रहा है...',
        empty_title: 'कोई पूछताछ नहीं मिली',
        empty_subtitle: 'जैसे ही किसान पूछताछ करेंगे, वे यहां दिखाई देंगी।',
        empty_search_subtitle: 'खोज से मेल खाने वाली कोई पूछताछ नहीं मिली।',
        error_title: 'कुछ गलत हो गया',
        error_load_list: 'पूछताछ लोड नहीं हो सकी। कृपया फिर से प्रयास करें।',
        error_load_detail:
          'पूछताछ विवरण लोड नहीं हो सका। कृपया फिर से प्रयास करें।',
        error_missing_id: 'पूछताछ आईडी उपलब्ध नहीं है।',
        error_invalid_payload: 'सर्वर से अमान्य पूछताछ डेटा मिला।',
        error_not_found: 'पूछताछ नहीं मिली',
        retry: 'फिर से कोशिश करें',
        back: 'वापस जाएं',
        type_label: 'पूछताछ प्रकार',
        crop_label: 'फसल',
        quantity_label: 'आवश्यक मात्रा',
        farmer_id_label: 'किसान आईडी',
        created_on: 'बनाई गई तिथि',
        updated_on: 'अपडेट की गई तिथि',
        description_title: 'विवरण',
        description_template:
          'किसान ने {{cropName}} फसल के लिए {{inquiryType}} सहायता मांगी है। मांगा गया उत्पाद: {{productName}}। आवश्यक मात्रा: {{quantityLabel}}।',
        attachment_title: 'संलग्नक',
        attachment_empty: 'कोई संलग्नक उपलब्ध नहीं है',
        fallback_na: 'उपलब्ध नहीं',
        fallback_not_specified: 'निर्दिष्ट नहीं',
        fallback_unknown: 'अज्ञात',
        fallback_date: 'तिथि उपलब्ध नहीं',
        status: {
          pending: 'नया',
          approved: 'स्वीकृत',
          rejected: 'अस्वीकृत',
      ...
      fpo_home: {
        ...
        Community: 'समुदाय',
        inquiry: 'पूछताछ',
        attendance_calendar: 'उपस्थिति कैलेंडर',
        assign_task: 'कार्य सौंपें',
        ...
        present: 'उपस्थित',
        absent: 'अनुपस्थित',
        not_marked: 'चिन्हित नहीं',
        farmer_attendance: 'किसान उपस्थिति',
        farmer: 'किसान',
        no_farmers_found: 'कोई किसान नहीं मिला',
      },

      all_active_farms: 'सभी सक्रिय खेत',
      farms_total: 'कुल खेत',
      no_active_farms_found: 'कोई सक्रिय खेत नहीं मिला।',
      ...
      all_tasks_assigned: {
        title: 'सभी कार्य',
        subtitle: 'टीम के कार्यों को प्रबंधित और ट्रैक करें',
        deadline: 'अंतिम तिथि',
        location: 'स्थान',
        no_internet: 'इंटरनेट कनेक्शन नहीं है',
        no_internet_subtitle:
        ...
        retry: 'पुनः प्रयास करें',
        failed_to_load: 'कार्य लोड करने में विफल',
        no_tasks: 'कोई कार्य नहीं मिला',
        no_tasks_subtitle: 'अभी तक कोई कार्य नहीं सौंपा गया है।',
        task_count_one: '{{count}} कार्य',
        task_count_other: '{{count}} कार्य',
      },
      ...
      assign_task: {
        ...
        required: '*',
        task_title_placeholder: 'कार्य का शीर्षक दर्ज करें',
        description: 'विवरण',
        description_placeholder: 'कार्य का विवरण दर्ज करें (वैकल्पिक)',
        assign_to: 'को सौंपें',
        failed_to_load: 'टीम के सदस्यों को लोड करने में विफल',
        retry: 'पुनः प्रयास करें',
        no_members: 'कोई टीम सदस्य नहीं मिला',
        due_date: 'अंतिम तिथि',
        due_date_placeholder: 'अंतिम तिथि चुनें',
        priority_level: 'प्राथमिकता स्तर',
        category: 'श्रेणी',
        location: 'स्थान (वैकल्पिक)',
        location_placeholder: 'कार्य स्थान दर्ज करें',
        creating: 'बनाया जा रहा है...',
        create_task: 'कार्य बनाएं',
        no_internet: 'इंटरनेट कनेक्शन नहीं है',
        validation: {
          title_required: 'कार्य का शीर्षक आवश्यक है',
          title_min_length: 'कार्य का शीर्षक कम से कम 3 वर्णों का होना चाहिए',
          title_max_length: 'कार्य का शीर्षक 100 वर्णों से अधिक नहीं हो सकता',
          title_invalid: 'कार्य के शीर्षक में अमान्य वर्ण हैं',
          description_max_length: 'विवरण 500 वर्णों से अधिक नहीं हो सकता',
          member_required: 'कृपया एक टीम सदस्य चुनें',
          member_invalid: 'अमान्य टीम सदस्य चुना गया',
          due_date_required: 'अंतिम तिथि आवश्यक है',
          due_date_past: 'अंतिम तिथि अतीत में नहीं हो सकती',
          priority_required: 'कृपया प्राथमिकता स्तर चुनें',
          category_required: 'कृपया एक श्रेणी चुनें',
          location_max_length: 'स्थान 200 वर्णों से अधिक नहीं हो सकता',
        },
        task_created: 'कार्य सफलतापूर्वक बनाया गया',
        task_failed: 'कार्य बनाने में विफल',
        priority_low: 'निम्न',
        priority_medium: 'मध्यम',
        priority_high: 'उच्च',
        category_field_visit: 'क्षेत्र का दौरा',
        category_customer_service: 'ग्राहक सेवा',
        category_inventory: 'इन्वेंटरी',
        category_delivery: 'वितरण',
        category_collection: 'संग्रह',
        category_documentation: 'दस्तावेज़ीकरण',
        category_other: 'अन्य',
      },

      task_assigned: {
        title: 'सौंपा गया कार्य',
        my_tasks: 'मेरे कार्य',
        no_internet:
          'कोई इंटरनेट कनेक्शन नहीं। कृपया जांचें और पुनः प्रयास करें।',
        session_expired: 'सत्र समाप्त। कृपया पुनः लॉगिन करें।',
        too_many_requests_retry:
          'बहुत अधिक अनुरोध। {{retryAfter}} सेकंड के बाद पुनः प्रयास करें।',
        ...
        something_went_wrong: 'कुछ गलत हो गया। कृपया पुनः प्रयास करें।',
        no_deadline: 'कोई अंतिम तिथि नहीं',
        invalid_date: 'अमान्य तिथि',
        unassigned: 'असाइन नहीं किया गया',
        untitled_task: 'बिना शीर्षक का कार्य',
        priority: 'प्राथमिकता',
        category: 'श्रेणी',
        due_date: 'अंतिम तिथि',
        failed_to_load: 'कार्य लोड करने में विफल',
        retry: 'पुनः प्रयास करें',
        no_tasks: 'अभी तक कोई कार्य नहीं सौंपा गया है',
        no_tasks_subtitle: 'नए कार्यों के लिए बाद में वापस जांचें',
        task_count_one: '{{count}} कार्य',
        task_count_other: '{{count}} कार्य',
      },

      staff_attendance: {
        title: 'कर्मचारी उपस्थिति',
        check_in: 'चेक इन',
        check_out: 'चेक आउट',
        present: 'उपस्थित',
      ...
      crop_analytics: {
        ...
        acre: 'एकड़',
        your_farms: 'आपके खेत',
        farm_boundary_mapped: 'खेत की सीमा मैप की गई',
        points: 'बिंदु',
        variety: 'किस्म',
        sowing: 'बुवाई',
        no_crops: 'कोई फसल नहीं',
        crop: 'फसल',
        crops_plural: 'फसलें',
        no_crops_planted: 'अभी तक कोई फसल नहीं लगाई गई',
        no_farm_data: 'कोई खेत डेटा उपलब्ध नहीं',
        start_adding_farm: 'अपना पहला खेत जोड़कर शुरू करें',
      },
    },
  },
};
