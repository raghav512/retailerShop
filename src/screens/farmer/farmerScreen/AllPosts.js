...
const ActionButton = ({ icon, count, isActive, onPress, activeColor = FARMER_COLORS.primaryLight }) => (
  <TouchableOpacity onPress={onPress} style={styles.iconButton} activeOpacity={0.7}>
    ...
    />
    <Text style={[styles.actionText, isActive && { color: activeColor, fontWeight: '700' }]}>{count || 0}</Text>
  </TouchableOpacity>
);
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <MessageIcon name="chatbubble-outline" size={20} color="#6B7280" />
