...
const RetailerMarketplace = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      fetchCartCount();
    }, [fetchMarketplaceItems, fetchCartCount]),
  );
  ...
  const handleProductPress = useCallback(
    group => {
      const first = group[0];
      navigation.navigate('RetailerProductDetails', {
        items: group,
  ...
  const renderItem = useCallback(
    ({ item: group }) => {
      ...
      return (
        <TouchableOpacity
          style={styles.card}
          onPress={() => handleProductPress(group)}
          activeOpacity={0.7}
        >
  ...
  return (
    <View style={styles.container}>
            ...
            return (
              ...
              >
                <Icon
                  ...
                  color={
                    isActive
                      ? RETAILER_COLORS.primary
                      : RETAILER_COLORS.textSecondary
                  }
                />
                <Text
                  style={[
      ...
      {loading ? (
        ...
        <View style={styles.stateContainer}>
          <Icon name="search-off" size={60} color={RETAILER_COLORS.tintMid} />
...
const styles = StyleSheet.create({
  ...
  /* TOP BAR - PREMIUM ELEVATED DESIGN */
  topBar: {
  ...
  /* CATEGORY CHIPS - ELEVATED DESIGN */
  categorySection: {
    marginTop: 20,
    marginBottom: 8,
  },
  ...
  /* PREMIUM PRODUCT CARD - LEVEL 1 ELEVATION */
  card: {
    width: '48%',
    backgroundColor: RETAILER_COLORS.surface,
    borderRadius: 20,
  ...
  categoryPillOverlay: {
    ...
    top: 8,
    left: 8,
    backgroundColor: RETAILER_COLORS.accent,
    borderRadius: 6,
    paddingHorizontal: 8,
    paddingVertical: 4,
    elevation: 2,
