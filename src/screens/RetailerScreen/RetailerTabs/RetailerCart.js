      ...
      <View style={styles.card}>
        <View style={styles.imageBox}>
          {imageUrl ? (
            ...
            <Icon name="cube" size={28} color={RETAILER_COLORS.primary} />
          )}
        </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backBtn} onPress={() => navigation.goBack()}>
          <Icon name="chevron-back" size={24} color={RETAILER_COLORS.primary} />
        </TouchableOpacity>
      ...
      {loading ? (
        ...
        <View style={styles.empty}>
          <View style={styles.emptyIconBox}>
            <Icon name="cart" size={64} color={RETAILER_COLORS.primary} />
          </View>
          ...
          <View style={styles.footer}>
            ...
            <View style={styles.paymentMethodContainer}>
              ...
              >
                ...
                <Icon name="cash" size={20} color={paymentMethod === 'CASH' ? RETAILER_COLORS.primary : "#6B7280"} style={{marginLeft: 8}} />
              ...
              >
                ...
                <Icon name="card" size={20} color={paymentMethod === 'CREDIT' ? RETAILER_COLORS.primary : "#6B7280"} style={{marginLeft: 8}} />
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    elevation: 4,
    shadowColor: RETAILER_COLORS.primaryDark,
    shadowOpacity: 0.06,
    shadowRadius: 10,
  ...
  card: {
    ...
    borderWidth: 1,
    borderColor: RETAILER_COLORS.tintMid + '30',
  },
  imageBox: {
    width: 64,
    height: 64,
  ...
  finalTotalRow: {
    ...
    paddingTop: 16,
    borderTopWidth: 1,
    borderTopColor: RETAILER_COLORS.tintMid,
    marginBottom: 20,
  },
  ...
  checkoutBtn: {
    backgroundColor: RETAILER_COLORS.primaryDark,
    borderRadius: 16,
    paddingVertical: 18,
    alignItems: "center",
    elevation: 3,
