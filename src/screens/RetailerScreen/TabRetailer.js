...
import {
  RetailerStackHome,
  RetailerStackMarketplace,
  RetailerStackOrders,
  RetailerStackProfile,
} from './RetailerStacks';

const Tab = createBottomTabNavigator();
const ACTIVE_COLOR = RETAILER_COLORS.primary;
const INACTIVE_COLOR = '#9CA3AF';
const TAB_BAR_BOTTOM_INSET_MAX = 10;
const TAB_BAR_BOTTOM_INSET_OVERRIDE = null;

const TAB_CONFIG = [
  { name: 'RetailerHomeTab',        icon: 'home',    labelKey: 'retailer_tabs.home'        },
  { name: 'RetailerMarketplaceTab', icon: 'cart',    labelKey: 'retailer_tabs.marketplace' },
  { name: 'RetailerOrdersTab',      icon: 'receipt', labelKey: 'retailer_tabs.orders'      },
  { name: 'RetailerProfileTab',     icon: 'person',  labelKey: 'retailer_tabs.profile'     },
];

const TabItem = ({ config, isFocused, onPress, t }) => {
...
const TabRetailer = () => {
  return (
    ...
    >
      <Tab.Screen name="RetailerHomeTab" component={RetailerStackHome} />
      <Tab.Screen
        name="RetailerMarketplaceTab"
        component={RetailerStackMarketplace}
      />
      <Tab.Screen name="RetailerOrdersTab" component={RetailerStackOrders} />
      <Tab.Screen name="RetailerProfileTab" component={RetailerStackProfile} />
    </Tab.Navigator>
  );
};

export default TabRetailer;
