      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={styles.headerLeft}>
            ...
            <View>
              <Text style={styles.farmName}>{item.farmName || "Farm Name"}</Text>
          ...
          <View style={styles.areaBox}>
            ...
            <Text style={styles.farmAreaUnit}>{item.unit || t("unit_acre") || "Acre"}</Text>
          </View>
        </View>
        ...
        <View style={styles.mapContainer}>
          {region ? (
            ...
            <View style={styles.noMapContainer}>
              ...
              <Text style={styles.noMapText}>{t("no_location_data") || "No map data available"}</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.cardFooter}>
          ...
          <Text style={styles.markersText}>{coordinates.length} {t("farm_details.points") || "Points"}</Text>
        </View>
      </View>
    );
  };
    ...
    <View style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>{t("farm_details_title") || "Farmer Details"}</Text>
      ...
      {loading ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>{t("no_farms_found") || "No farms found for this farmer."}</Text>
        </View>
      ) : (
        <FlatList
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    elevation: 4, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.07, shadowRadius: 10,
  },
  cardHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 16 },
  headerLeft: { flexDirection: "row", alignItems: "center" },
  iconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: "#EBF3F6", justifyContent: "center", alignItems: "center", marginRight: 12 },
  farmName: { fontSize: 16, fontWeight: "800", color: "#1F2937", marginBottom: 4 },
  ...
  farmAreaUnit: { fontSize: 11, fontWeight: "600", color: "#9CA3AF", marginTop: 2 },

  /* MAP */
  mapContainer: {
    height: 180, width: "100%", borderRadius: 16, overflow: "hidden", marginBottom: 12,
    borderWidth: 1, borderColor: "#F3F4F6",
  },
  map: { ...StyleSheet.absoluteFillObject },
  noMapContainer: { flex: 1, backgroundColor: "#FAFAFA", justifyContent: "center", alignItems: "center" },
  noMapText: { color: "#9CA3AF", fontSize: 13, marginTop: 8, fontWeight: "500" },

  /* FOOTER */
  cardFooter: { flexDirection: "row", alignItems: "center", paddingTop: 12, borderTopWidth: 1, borderTopColor: "#F3F4F6" },
  markersText: { fontSize: 13, color: "#6B7280", fontWeight: "600", marginLeft: 4 },
});
