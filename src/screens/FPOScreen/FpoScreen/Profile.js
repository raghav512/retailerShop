...
const FEATURES = [{ id: '3', key: 'documents', icon: 'document-text-outline' }];
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() =>
              navigation.navigate('UpdateProfile', { profileData: profile })
            }
          >
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionIcon}>
              <Icon name="person" size={15} color={THEME} />
            </View>
            <Text style={styles.sectionTitle}>
              {t('fpo_profile.account_details')}
            </Text>
          </View>
          {accountDetails.map((item, i) => (
            <View
              ...
              style={[
                styles.detailRow,
                i === accountDetails.length - 1 && { borderBottomWidth: 0 },
              ]}
            >
              <View style={styles.detailLeft}>
                <Icon name={item.icon} size={16} color="#9CA3AF" />
                <Text style={styles.detailLabel}>
                  {t(`fpo_profile.account.${item.label}`)}
                </Text>
              </View>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionIcon}>
              <Icon name="apps" size={15} color={THEME} />
            </View>
            <Text style={styles.sectionTitle}>
              {t('fpo_profile.features_title')}
            </Text>
          </View>
          {features.map((item, i) => (
            <TouchableOpacity
              ...
              <View style={styles.featureLeft}>
                ...
                <View>
                  <Text style={styles.featureTitle}>
                    {t(`fpo_profile.features.${item.key}.title`)}
                  </Text>
                  <Text style={styles.featureSub}>
                    {t(`fpo_profile.features.${item.key}.sub`)}
                  </Text>
                </View>
              </View>
